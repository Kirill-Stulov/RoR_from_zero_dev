...
module Validator
  ...
  RAILWAYSTATION_NAME_PATTERN = /^[a-zA-Z]{4}$/   # {4} означает длину не меньше 4 символов!!!!  !!!константа с допустимым форматом имени станции. Шаблон - любые четыре строчные или прописные латинские буквы/ #{4} обозначает допустимое количество повторений подшаблона !!!! в случае диапозона, если нужно ровно 4 символа не больне ни меньше, то указываем что 4 с начала и 4 с конца. ^ начало $ конец
