# @@ - class variable
# https://www.codecademy.com/courses/learn-ruby/lessons/object-oriented-programming-i/exercises/twice-the--twice-as-classy?action=resume_content_item
...
class Person
  # Set your class variable to 0 on line 22
  @@people_count = 0
  
  def initialize(name)
    @name = name
    # Increment your class variable on line 27
    @@people_count += 1
  end
  
  def self.number_of_instances
    # Return your class variable on line 32
    return @@people_count
  end
end
