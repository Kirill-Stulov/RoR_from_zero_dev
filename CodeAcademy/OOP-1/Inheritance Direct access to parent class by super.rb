# Inheritance Direct access to parent(super) class by super
...
# Replace the return statement inside Dragon‘s definition of fight with the keyword super. 
# (No need to pass any arguments to super, since Creature‘s fight method doesn’t take any.)
