# Ruby statement without going to a new line (Inheritance)
# https://www.codecademy.com/courses/learn-ruby/lessons/object-oriented-programming-i/exercises/there-can-be-only-one
