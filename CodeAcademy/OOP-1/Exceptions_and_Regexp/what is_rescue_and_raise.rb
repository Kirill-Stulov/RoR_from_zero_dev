...
# raise используем когда после обработки исключения (rescue), нужно выбросить его повторно. 
	# Вызываем raise без параметров в блоке rescue - Для этого после rescue в блоке обработке пишем raise  Исключения 00:24:30	
	...
	rescue NoMemoryError => e     # т.е прога остановилась, все что было после блока begin end - не выполнилось
		puts "No memory!!!"
	end
