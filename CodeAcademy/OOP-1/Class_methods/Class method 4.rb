# class method 4
# Ruby on Rails c нуля (2015) [Базовый]\Занятие 05. Методы класса, Модули и объектная модель Ruby 0:13:52

!!!!!!!!!!!!!!!!!!!!!!ЭТОТ ПРИМЕР НЕ ЗАКОНЧЕН!!!!!!!!!!!!!!!!!!!

# Метод класса применяется когда невозможно или не логично отнести метод к конкретному объекту
# Одним из таких случаев является использование методов класса непосредсвенно в классе
