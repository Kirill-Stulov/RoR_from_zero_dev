...
# 2. СПОСОБ задания блока как аргумента метода. - В этом случае блок в списке аргументов должен быть последним и оно начинается с &. (Если нужен блок как именованный аргумент и прииэтом нужен обычный нормальный синтаксис )
  # Пример:
