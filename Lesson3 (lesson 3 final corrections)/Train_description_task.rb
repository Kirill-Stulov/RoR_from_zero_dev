=begin
	С этого занятия мы будем создавать приложение, которое поможет диспетчеру железнодорожной странции управлять поездами: 
    ...
    Готовый файл тут https://github.com/vokshirg/Thinknetica/blob/master/lesson3/train.rb
=end